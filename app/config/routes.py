...
routes['GET']['/course/add'] = 'Courses#add'
routes['POST']['/course/add/process'] = 'Courses#add_process'
routes['GET']['/course/<id>/delete'] = 'Courses#delete'
routes['GET']['/course/<id>/delete/process'] = 'Courses#delete_process'
"""
